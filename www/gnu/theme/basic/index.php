...
<script src="/gnu/js/4th/4th.js"></script>
...
<section id="slogen">
    <div class="position-relative">
        <img src="/gnu/img/pwatch.png" alt="">
        <div class="pwat">
            <div class="position-absolute poem">
                <p>"당신은 셔터만 누르세요</p>
                <p>나머지는 저희가 할게요."</p>
            </div>
            <div class="bg_g position-absolute d-flex align-items-center justify-content-center">
                <a href="https://www.kodakphotoprinter.co.kr/">
                    <img src="/gnu/img/klogo.png" alt="">
                    <span>코닥홈페이지 바로가기</span>
                </a>
            </div>
        </div>
    </div>
...
<section class="section py-5" id="photo">
  <div class="container">
    <div>
        <h3 class="text-center display-2">Photo Studio</h3>
        <p class="text-center sub">코닥과 함께한 사람들의 이야기를 들어보세요</p>
        <ul class="row mx-0 align-items-center">
            <li class="col-6 col-lg-4 sc p-2 text-center"><a href="#none"><img src="/gnu/img/ps_1.png" alt="사진1" class="img-fluid"></a></li>
            <li class="col-6 col-lg-4 sc p-2 text-center"><a href="#none"><img src="/gnu/img/ps_2.png" alt="사진2" class="img-fluid"></a></li>
            <li class="col-6 col-lg-4 sc p-2 text-center"><a href="#none"><img src="/gnu/img/ps_3.png" alt="사진3" class="img-fluid"></a></li>
            <li class="col-6 col-lg-4 sc p-2 text-center"><a href="#none"><img src="/gnu/img/ps_4.png" alt="사진4" class="img-fluid"></a></li>
            <li class="col-6 col-lg-4 sc p-2 text-center"><a href="#none"><img src="/gnu/img/ps_5.png" alt="사진5" class="img-fluid"></a></li>
            <li class="col-6 col-lg-4 sc p-2 text-center"><a href="#none"><img src="/gnu/img/ps_6.png" alt="사진6" class="img-fluid"></a></li>
        </ul>
    </div>
  </div>
</section>
<section class="section py-5" id="product">
    <div class="container">
        ...
        <div class="card position-relative border-0 swiper-container">
            ...
            <div class="container">
                <div>
                    <ul class="d-flex justify-content-center p-3">
                        <li class="p-4"><a href="#none">회사소개</a></li>
                        <li class="p-4"><a href="#none">이용약관</a></li>
                        <li class="p-4"><a href="#none">개인정보처리방침</a></li>
                    </ul>
                </div>
                <div class="d-flex justify-content-center ft_m row">
                    <div class="cs text-left col-lg-3">
                        <h4>CS Center</h4>
                        <strong>070.5213.7814</strong>
                        <p>
                            월요일~금요일 / AM 10:00 - PM 05:00<br>
                            주말 및 공휴일은 운영하지 않습니다.<br>
                            점심시간 PM 12:00 - PM 01:00<br>
                        </p>
                    </div>
                    <div class="comp text-left col-lg-4 pl-lg-5 pr-0">
                        <h4>ABOUT KODAK</h4>
                        <p>
                            상호 :프리닉스 주식회사<br>
                            대표 :노광호<br>
                            사업자등록번호 :124-86-38688<br>
                            통신판매업신고번호 :2016-수원권선-0285<br>
                            주소 :경기도 수원시 권선구 산업로156번길 197-50 프리닉스<br>
                        </p>
                    </div>
                </div>
            </div>
